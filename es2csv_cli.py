...
def main():
    ...
    p.add_argument('--aws_access_key', dest='aws_access_key', type=str, required=False, help='AWS Access Key')
    p.add_argument('--aws_secret_key', dest='aws_secret_key', type=str, required=False, help='AWS Secret Key')
    p.add_argument('--aws_region', dest='aws_region', type=str, required=False, help='AWS Region (Eg. us-east-1)')
